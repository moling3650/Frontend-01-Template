...
DoubleStringCharacter ::
  ...
  - \<LS\> `^\u2028$`
  - \<PS\> `^\u2029$`
  - \ EscapeSequence`/^\\(u[0-9a-fA-F]{4}$|u\{(10|0?[0-9a-fA-F])[0-9a-fA-F]{0,4}\}$|x[0-9a-fA-F]{2}$|0(?!=\d)$|[^\n\r\u2028\u2029\dxu]$)/u`
  - LineContinuation`/^\\(\n|\r\n?|\u2028|\u2029)$/u`
...
```js
/^u[0-9a-fA-F]{4}$|^u\{(10|0?[0-9a-fA-F])[0-9a-fA-F]{0,4}\}$|^x[0-9a-fA-F]{2}$|^0(?!=\d)$|^[^\n\r\u2028\u2029\dxu]$/u
```
EscapeSequence ::
  - CharacterEscapeSequence `/^[^\n\r\u2028\u2029\dxu]$/u`
  - 0 \[lookahead ∉ DecimalDigit\]`/^0(?!=\d)$/`
  - HexEscapeSequence  `/^x[0-9a-fA-F]{2}$/`
  - UnicodeEscapeSequence`/^u[0-9a-fA-F]{4}$|^u\{(10|0?[0-9a-fA-F])[0-9a-fA-F]{0,4}\}$/`
